			...
			<xsl:otherwise>
				...
				<xsl:choose>
						...
						<xsl:choose>
							...
							<!-- ================================================== -->
								<persname relator="creator" encodinganalog="100" source="lc">
									<part>
										<xsl:value-of select="replace($first, ', ', '&lt;/part&gt;&lt;part&gt;')" disable-output-escaping="yes"/>
									</part>
								</persname>
							</xsl:when>
							<xsl:otherwise>
					...
					<xsl:when test="contains($selector, 'lang')">
						<language>
							<xsl:attribute name="langcode" select="$first"/>
		...
		<ead audience="external" relatedencoding="MARC21">
			<control countryencoding="iso3166-1" dateencoding="iso8601" langencoding="iso639-2b" repositoryencoding="iso15511" scriptencoding="iso15924">
				...
				<localtypedeclaration>
					<citation href="https://wiki.umbc.edu/display/library/Special+Collections+Procedures?preview=/11437110/11731403/UMBCProcessing_Description.pdf" lastdatetimeverified="2015-02-24"><xsl:text>Archives Processing Manual: Description (2012)</xsl:text></citation>
					<descriptivenote>
