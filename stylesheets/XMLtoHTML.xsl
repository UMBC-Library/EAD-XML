	...
	<xsl:template match="ead">
        <html>
            <head>
                ...
                <!-- Our CSS stylesheet -->
                <link rel="stylesheet" type="text/css" href="../CSS/EADstyle.css" />
				...
				<!-- For collapse/expand of info -->
				<script type='text/javascript'>
				 function unhide(divID) {
					 var item = document.getElementById(divID);
					 if (item) {
						item.className=(item.className=='hiddeninfo')?'unhidden collinfo':'hiddeninfo';
					 }
				 }
				 </script>
                <!-- Google fonts -->
            ...
            <body>
                <div id="header">
                    <img src="../images/logo.jpg" width="200px" align="left"/>
                ...
                <div id="leftbar">
                    ...
                    <div id="nav">
                        <ul>
                            ...
                            <li><a href="#adminbiog" title="skip to Admin Bio Note">Administrative/Biographical Note</a></li>
                            ...
                            <li><a href="{concat('../EAD PDFs/', archdesc/did/unitid, '.pdf')}" title="go to PDF" target="_blank">View PDF</a></li>
                        </ul>
                    </div>
                </div>
				<div id="content-wrapper">
                    <div id="firstbox">
                        ...
                        <div id="images">
                            <a class="fancybox" href="../images/img1.jpg"><img src="../images/img1.jpg" alt="some_text" width="150"></img></a>
                            <a class="fancybox" href="../images/img2.jpg"><img src="../images/img2.jpg" alt="some_text" width="150"></img></a>
                            <a class="fancybox" href="../images/img3.jpg"><img src="../images/img3.jpg" alt="some_text" width="150"></img></a>
                        </div>
                    </div>
					<div id="secondbox">
                        <div class="section2">
                        ...
                        <div class="section3">
                            ...
                            <p><xsl:value-of select="control/localtypedeclaration/citation"/></p>
							...
							<div class="section6">
								...
								<xsl:choose> 
									<xsl:when test="archdesc/dsc/*[@level='series']">
										<ol><xsl:apply-templates select="archdesc/dsc/*[@level='series']"/></ol>
									</xsl:when>
									<xsl:when test="archdesc/dsc/*[@level='file']">
										<ol><li><table id="folder">
											<tr>
        ...
        <li>
            ...
            <xsl:choose>
                <xsl:when test="./*[@level='subseries']">
                    <ol><xsl:apply-templates select="./*[@level='subseries']"/></ol>
                </xsl:when>
